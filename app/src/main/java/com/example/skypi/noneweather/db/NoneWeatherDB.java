 ...
 */
public class NoneWeatherDB {
    /*数据库名字*/
    public static final String DB_NAME ="none_weather";
    /*数据库版本*/
    public static final int VERSION = 1;
    private static NoneWeatherDB noneWeatherDB;
    private SQLiteDatabase db;

    public NoneWeatherDB(Context context) {
        NoneWeatherOpenHelper dbHelper = new NoneWeatherOpenHelper(context,DB_NAME,null,VERSION);
        db=dbHelper.getWritableDatabase();
    }
    /*获取NoneWeather 实例*/
    public synchronized static NoneWeatherDB getInstance(Context context){
        if (noneWeatherDB ==null){
            noneWeatherDB = new NoneWeatherDB(context);
        }
        return noneWeatherDB;
    }
